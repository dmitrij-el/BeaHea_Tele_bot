...
account_basic_data = dict(
    ...
    change_name=['{user_name}', StateUserProfileBasicData.change_name],
    change_surname=['{user_surname}', StateUserProfileBasicData.change_surname],
    change_patronymic=['{user_patronymic}', StateUserProfileBasicData.change_patronymic],
    change_date_birth=['{date_birth}', StateUserProfileBasicData.change_date_birth],
    change_gender=['{gender}', StateUserProfileBasicData.change_gender],
    change_height=['{height} см', StateUserProfileBasicData.change_height],
    change_weight=['{weight} кг', StateUserProfileBasicData.change_weight],
    change_email=['{email}', StateUserProfileBasicData.change_email],
    change_phone=['{phone}', StateUserProfileBasicData.change_phone],
    profile_communication_channel=['Канал связи {communication_channel}',
                                   StateUserProfileBasicData.change_communication_channels]
)
